    ...
    return (
      <div className="rounded-lg border border-gold/40 bg-gold/5 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <div className="font-display text-lg tracking-wide text-gold-2">{t('init.title')}</div>
        </div>
        <div className="mt-1 text-sm text-muted">{t('turnIndicator.enterD20Hint')}</div>
      </div>
    )
  }
    ...
    return (
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div className="font-display text-2xl tracking-wide text-gold-2">{t('turnIndicator.yourTurn')}</div>
        </div>
  ...
  return (
    <div className="rounded-lg border border-line bg-panel/50 px-4 py-3">
      <div className="flex items-center gap-2">
        ...
        <div className="font-display text-lg tracking-wide text-muted">{t('turnIndicator.waiting')}</div>
      </div>
      <div className="mt-1 text-sm text-muted">{current ? t('tracker.whoseTurn', { name: current.name }) : t('turnIndicator.waitingForTurn')}</div>
    </div>
  )
}
