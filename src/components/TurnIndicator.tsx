  ...
  if (setup) {
    return (
      <div className="rounded-lg border border-gold/40 bg-gold/5 px-4 py-3">
        ...
        <div className="mt-1 text-sm text-muted">{t('turn.enterD20Dex')}</div>
      </div>
    )
  }
    ...
    return (
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div className="font-display text-2xl tracking-wide text-gold-2">{t('turn.yourTurn')}</div>
        </div>
  ...
  return (
    <div className="rounded-lg border border-line bg-panel/50 px-4 py-3">
      <div className="flex items-center gap-2">
        ...
        <div className="font-display text-lg tracking-wide text-muted">{t('turn.waitingLabel')}</div>
      </div>
      <div className="mt-1 text-sm text-muted">{current ? t('turn.turnOf', { name: current.name }) : t('turn.waitingForTurn')}</div>
    </div>
  )
}
