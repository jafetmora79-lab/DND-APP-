...
const en = {
  ...
  'map.maker.blurb': 'Each square is 5 feet. Paint walls that block sight, holes you cannot walk, and difficult ground.',
...
const es: Record<keyof typeof en, string> = {
  ...
  'map.maker.blurb': 'Cada casilla son 5 pies. Pinta muros que bloquean la vista, hoyos intransitables y terreno difícil.',
